...
dz_array = {
        "public":{
            ...
            "description":"Dipa Learning Center",
            "og_title":"Dipa Learning Center",
            "og_description":"Dipa Learning Center",
            "og_image":"",
            "title":"Dipa Learning Center",
        },
        "global":{
            "css":[
                    f"{folder_name}/vendor/jquery-nice-select/css/nice-select.css",
                    f"{folder_name}/icons/simple-line-icons/css/simple-line-icons.css",
                    f"{folder_name}/icons/font-awesome/css/all.min.css",
                    f"{folder_name}/icons/material-design-iconic-font/css/materialdesignicons.min.css",
                    f"{folder_name}/icons/themify-icons/css/themify-icons.css",
                    f"{folder_name}/icons/line-awesome/css/line-awesome.min.css",
                    f"{folder_name}/icons/avasta/css/style.css",
                    f"{folder_name}/icons/flaticon/flaticon.css",
                    f"{folder_name}/icons/flaticon_1/flaticon_1.css",
                    f"{folder_name}/icons/icomoon/icomoon.css",
                    f"{folder_name}/icons/bootstrap-icons/font/bootstrap-icons.css",
                    f"{folder_name}/vendor/animate/animate.min.css",
                    f"{folder_name}/vendor/aos/css/aos.min.css",
                    f"{folder_name}/vendor/perfect-scrollbar/css/perfect-scrollbar.css",
                    f"{folder_name}/vendor/metismenu/css/metisMenu.min.css",
                    f"{folder_name}/css/style.css",
                    f"{folder_name}/css/dipa-custom.css"
                ],
                ...
                "views":{
                    ...
                    "js":{
                        ...
                        "index_3":[
                            ...
                            f"{folder_name}/js/dashboard/dashboard-3.js",
                        ],
                        ...
                        "index_4":[
                            ...
                            f"{folder_name}/js/dashboard/dashboard-4.js",
                        ],
                        ...
                        "index_5":[
                            ...
                            f"{folder_name}/vendor/peity/jquery.peity.min.js",
                            f"{folder_name}/vendor/swiper/js/swiper-bundle.min.js",
                            f"{folder_name}/js/dashboard/dashboard-5.js",
                        ],
                        ...
                        "index_6":[
                            ...
                            f"{folder_name}/vendor/apexchart/apexchart.js",
                            f"{folder_name}/vendor/peity/jquery.peity.min.js",
                            f"{folder_name}/js/dashboard/dashboard-6.js",
                        ],
                        ...
                        "index_7":[
                            ...
                            f"{folder_name}/vendor/apexchart/apexchart.js",
                            f"{folder_name}/vendor/peity/jquery.peity.min.js",
                            f"{folder_name}/js/dashboard/dashboard-7.js",
                        ],
                        ...
                        "index_8":[
                            ...
                            f"{folder_name}/vendor/peity/jquery.peity.min.js",
                            f"{folder_name}/vendor/swiper/js/swiper-bundle.min.js",
                            f"{folder_name}/js/dashboard/dashboard-8.js",
                        ],
                        ...
                        "transaction_details":[
                            f"{folder_name}/vendor/apexchart/apexchart.js",
                            f"{folder_name}/js/dashboard/transaction-details.js",
                        ],
                        "content":[
