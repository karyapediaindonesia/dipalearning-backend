...
for branch in branches:
    ...
    # 2. Front Admin / CS: 2 per branch
    for _ in range(2):
        create_employee(branch, 'Front Admin / CS', 'FRN', 'F', 'FULL_TIME')

    # 3. Coach: 15-25 per branch, mixed employee type
